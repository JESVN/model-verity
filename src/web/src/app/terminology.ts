...
export const BUILTIN_UPDATE_COPY = {
  ...
  check: "检查更新",
  prepare: "下载数据到本地",
  prepareHelp: "仅把 Zenodo 数据下载到服务器本地并建立模型列表（首次需数百 MB，缓存上限 2GB，可一键清理）。下载 ≠ 更新内置：下载完成后在上方刷新现有模型、在下方下载新样本。",
  applyPending: "数据已下载到本地，尚未应用。勾选后点击对应区的「更新内置样本」或「下载新样本」使其生效。",
  applyCurrent: "当前内置参考已使用这份已下载的数据。",
  rollback: "回滚到上一版本",
  cleanCache: "清理数据集缓存",
  cancel: "取消",
  refresh: "重新检查",
